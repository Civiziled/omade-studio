    ...
    <section class="min-h-screen bg-studio-dark relative z-10 pt-32 pb-20 flex flex-col items-center">
        ...
        <div class="w-full max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 reveal-up">
                <h2 class="text-sm font-bold tracking-[0.3em] text-studio-accent uppercase mb-4">Nos Tarifs</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-zinc-900/50 p-8 rounded-[2rem] border border-white/5 backdrop-blur-sm reveal-up hover:border-studio-accent/30 transition-all flex flex-col">
                    <div class="text-studio-accent text-sm font-bold tracking-widest uppercase mb-2">Mixage</div>
                ...
                <!-- 300€ -->
                <div class="bg-zinc-900/50 p-8 rounded-[2rem] border border-white/5 backdrop-blur-sm reveal-up hover:border-studio-accent/30 transition-all flex flex-col">
                    <div class="text-studio-accent text-sm font-bold tracking-widest uppercase mb-2">Mixage • Formule Premium</div>
            ...
            <div class="mt-8 max-w-3xl mx-auto bg-zinc-900/50 p-8 md:p-12 rounded-[2rem] border border-white/5 backdrop-blur-sm reveal-up hover:border-studio-accent/30 transition-all text-center">
                <div class="text-studio-accent text-sm font-bold tracking-widest uppercase mb-2">Enregistrement</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div>
                        <h5 class="text-studio-accent font-bold text-sm tracking-widest uppercase mb-3">La Session</h5>
                    ...
                    <div>
                        <h5 class="text-studio-accent font-bold text-sm tracking-widest uppercase mb-3">Le Pré-Mix Inclus</h5>
            ...
            <div class="mt-8 max-w-3xl mx-auto bg-zinc-900/50 p-8 rounded-[2rem] border border-white/5 backdrop-blur-sm reveal-up text-center hover:border-studio-accent/30 transition-all">
                <div class="text-studio-accent text-sm font-bold tracking-widest uppercase mb-2">Mastering</div>
